...
To support any of the Weaver protocols, the _Core Network Capabilities_ must be implemented in the interoperation module for a given network and the _Relay Capabilities_ must be implemented in the relay/driver combination for that network.
